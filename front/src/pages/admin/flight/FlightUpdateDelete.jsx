...
import {useUpdateFlightMutation,useGetFlightByIdQuery,useUploadImageMutation} from "../../../redux/api/flightApiSlice"
import { toast } from 'react-toastify'
import { useNavigate, useParams } from 'react-router'
const FlightUpdateDelete = () => {
    ...
    const [update] = useUpdateFlightMutation()
...
const{data} = await update({flightId,formData })
...
export default FlightUpdateDelete