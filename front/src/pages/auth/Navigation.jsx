...
const Navigation = () => {
  ...
  return (
    ...
    <div className="navbar-start">
      ...
      <Link to="/" className="btn btn-ghost text-xl">FLIGHT</Link>
    </div>
    <div className="navbar-center hidden lg:flex font-bold">
      <ul className="menu menu-horizontal px-1">
        <li><Link to="/">Home</Link></li>
        <li>
          <Link to="/package">OUR PACKAGES
          </Link>
        </li>
        <li><Link to="/flights">FLIGHTS
        </Link></li>
        <li><Link to="/about">About Us</Link></li>
...
<ul className=' flex items-center justify-center gap-4'>
    <li><Link to="/login"><AiOutlineLogin size={26}/> Login</Link></li>
<li><Link to="/register"><AiOutlineUserAdd size={26}/>Register</Link></li>
</ul>
        )
      }
    </div>
